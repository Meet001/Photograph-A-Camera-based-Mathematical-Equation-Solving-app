/**
 * Computes and displays the eigenvectors of square matrices
 */
...
public class EigenvectorFragment extends ListFragment {
    ...
    {
        Bundle bundle = SquareList.get(position).GetEigenVector().GetDataBundled();
